...
enum ShadowSubmissionError {
    ...
    // UnknownFinalBlock,
    // #[error("block already has shadows")]
    // BlockAlreadyHasShadows,
    #[error("unknown error")]
    UnknownError,
}

pub const UNKNOWN_ERROR: i32 = -39001;
pub const UNKNOWN_ERROR_MSG: &str = "Unknown shadow submission error";

#[cfg(feature = "jsonrpsee-types")]
impl From<ShadowSubmissionError> for jsonrpsee_types::error::ErrorObject<'static> {
    fn from(value: ShadowSubmissionError) -> Self {
        match value {
            ShadowSubmissionError::UnknownError => jsonrpsee_types::error::ErrorObject::owned(
                UNKNOWN_ERROR,
                UNKNOWN_ERROR_MSG,
                None::<()>,
            ), // ShadowSubmissionError::UpdatedInvalidPayloadAttributes => {
               ...
               //     )
               // }
               // ShadowSubmissionError::InvalidState => jsonrpsee_types::error::ErrorObject::owned(
               //     INVALID_FORK_CHOICE_STATE_ERROR,
               //     INVALID_FORK_CHOICE_STATE_ERROR_MSG,
               //     None::<()>,
               // ),
               // ShadowSubmissionError::UnknownFinalBlock => jsonrpsee_types::error::ErrorObject::owned(
               //     INVALID_FORK_CHOICE_STATE_ERROR,
               //     INVALID_FORK_CHOICE_STATE_ERROR_MSG,
               //     None::<()>,
               // ),
