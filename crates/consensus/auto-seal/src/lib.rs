...
use reth_primitives::{
    irys_primitives::Shadows, proofs, Block, BlockBody, BlockHashOrNumber, BlockWithSenders,
...
impl StorageInner {
        ...
        ChainSpec: EthChainSpec + EthereumHardforks,
    {
        ...
        let body =
            BlockBody { transactions: body.transactions, ommers, withdrawals, requests, shadows };
